...
namespace FYPMSWebsite.Student
{
    ...
    {
        //**************************************************************
        // Uses TODO 26, 27, 28, 29, 30; in SharedAccess.cs 34, 37, 40 *
        //**************************************************************
        ...
        private void PopulateGroupMembers(string groupId)
        {
            ...
            // Uses TODO 37 in SharedAccess.cs.
            dtGroupMembers = mySharedAccess.GetProjectGroupMembers(groupId, lblResultMessage);
                ...
                if (dtGroupMembers.Rows.Count != 0)
                {
                    ...
                    if (isAssigned != "SQL_ERROR")
                    {
                        ...
                        else
                        {
                            ...
                            DataTable dtProjectsInterestedIn = mySharedAccess.GetProjectsGroupInterestedIn(groupId, lblResultMessage);
