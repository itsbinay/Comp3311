<%@ Page Title="" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="CreateProject.aspx.cs" Inherits="FYPMSWebsite.Faculty.CreateProject" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" runat="server">
    <asp:HiddenField ID="hfSQLError" runat="server" Visible="False" Value="false" />
    <div class="form-horizontal" role="form">
        <h4><span style="text-decoration: underline; color: #800000" class="h4"><strong>Create Project</strong></span></h4>
        ...
        <asp:Panel ID="pnlProjectInfo" runat="server">
            ...
            <div class="form-group" role="row">
                ...
                <asp:Label runat="server" Text="Co-supervisor:" CssClass="control-label col-md-2" AssociatedControlID="ddlCosupervisor" 
                    Font-Names="Arial" Font-Size="Small"></asp:Label>
                <div class="col-md-2">
                ...
                <asp:Label runat="server" Text="Category:" CssClass="control-label col-md-1" AssociatedControlID="ddlCategory" 
                    Font-Names="Arial" Font-Size="Small"></asp:Label>
                <div class="col-md-3">
                ...
                <asp:Label runat="server" Text="Type:" CssClass="control-label col-md-1" AssociatedControlID="rblType" 
                    Font-Names="Arial" Font-Size="Small"></asp:Label>
                <div class="col-md-3">
            ...
            <div class="form-group" role="row">
                ...
                <asp:Label runat="server" Text="Requirement:" CssClass="control-label col-md-2" AssociatedControlID="txtRequirement" 
                    Font-Names="Arial" Font-Size="Small"></asp:Label>
                <div class="col-md-10">
                    <asp:TextBox ID="txtRequirement" runat="server" CssClass="form-control input-sm" MaxLength="200" Wrap="False" 
            ...
            <div class="form-group" role="row">
                <div class="col-md-offset-2 col-md-2">
                    <asp:Button ID="btnCreate" runat="server" Text="Create Project" CssClass="btn-sm" OnClick="BtnCreate_Click"
